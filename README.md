...
The paper itself is arXiv:2609.01761; neither the PDF nor its LaTeX source is in this repository.
...
The reported numbers were produced with python 3.14.3, numpy 2.4.2 and matplotlib 3.10.8.
...
This repository contains the code and the stored experimental outputs for "Pooling and Drift in
Delayed Bandits".
